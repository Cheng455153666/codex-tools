...
pub fn save_general_config(
    ...
    let new_config = UserConfig {
        ...
        hermes_codex_auth_overwrite_on_switch: hermes_codex_auth_overwrite_on_switch
            .unwrap_or(current.hermes_codex_auth_overwrite_on_switch),
        hermes_gateway_restart_on_switch: hermes_gateway_restart_on_switch
            .unwrap_or(current.hermes_gateway_restart_on_switch),
