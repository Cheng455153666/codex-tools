...
impl Default for UserConfig {
    fn default() -> Self {
        Self {
            ...
            hermes_codex_auth_overwrite_on_switch: default_hermes_codex_auth_overwrite_on_switch(),
...
pub fn load_user_config() -> Result<UserConfig, String> {
    ...
    if let Some(obj) = value.as_object_mut() {
        ...
        if !obj.contains_key("hermes_codex_auth_overwrite_on_switch") {
            obj.insert(
                "hermes_codex_auth_overwrite_on_switch".to_string(),
                json!(default_hermes_codex_auth_overwrite_on_switch()),
            );
        }
        if !obj.contains_key("hermes_gateway_restart_on_switch") {
            obj.insert(
                "hermes_gateway_restart_on_switch".to_string(),
                json!(default_hermes_gateway_restart_on_switch()),
            );
        }
